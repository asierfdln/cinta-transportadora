...
MASK_IMAGE = "mask.jpg"
OUTPUT_IMAGE = "01output.png"
OUTPUT_MASKED_IMAGE = "01outputmasked.png"
...
def match_histograms(src_image, ref_image):
    ...
    image_after_matching = cv2.merge(
        [
            blue_after_transform,
            green_after_transform,
            red_after_transform
        ]
    )
...
def main():
    ...
    # image_src = my_polygon_mask(img=image_src, return_masked_img=True)
    # image_ref = my_polygon_mask(img=image_ref, return_masked_img=True)
    ...
    output_image = my_polygon_mask(img=output_image, return_masked_img=True)
