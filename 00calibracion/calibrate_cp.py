#!/usr/bin/env python
# calibrate_cp.py "fotos_calib/img*.jpg"
...
def main():
    ...
    args = dict(args)
    args.setdefault('--debug', './fotos_calib_output/')
    ...
    # with open(f'cam_undistort_{datetime.now().strftime("%d-%m-%Y-%H-%M-%S")}.json', 'w') as write_file:
